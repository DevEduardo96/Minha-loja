        ...
        <div className="container-politica">
          <div className="politica-container">
            ...
            <p>
              ...
              ou realiza uma compra em nosso site.
            </p>

            <h3>1. Informações que coletamos</h3>
            <p>
              Ao visitar o site, coletamos automaticamente certas informações
              sobre seu dispositivo, como endereço IP, tipo de navegador,
              páginas acessadas e horário da visita. Além disso, quando você
              realiza uma compra ou entra em contato, coletamos informações como
              nome, e-mail e forma de pagamento.
            </p>
            ...
            <p>
              ...
              pessoais. No entanto, nenhuma transmissão de dados na internet é
              100% segura.
            </p>

            <h3>5. Seus direitos</h3>
            <p>
              Você pode solicitar acesso, correção ou exclusão de suas
              informações pessoais a qualquer momento, entrando em contato
              conosco.
            </p>
            ...
            <p>
              ...
              recente sempre estará disponível nesta página.
            </p>

            <h3>8. Contato</h3>
            <p>
              Em caso de dúvidas sobre esta política, entre em contato pelo
              e-mail: <strong>contato@seudominio.com</strong>
            </p>
