      ...
      <div className="container-secundario">
        ...
        <div className="container-termos">
          <div className="termos-container">
            ...
            <p>
              Ao acessar este site e utilizar nossos serviços, você concorda com
            ...
            <h3>1. Uso do site</h3>
            <p>
              O conteúdo deste site é destinado para uso pessoal e não
              comercial. Você concorda em não reproduzir, duplicar ou explorar
              qualquer parte do site sem permissão expressa.
            </p>

            <h3>2. Produtos e serviços</h3>
            <p>
              Os produtos digitais oferecidos estão sujeitos a disponibilidade e
              podem ser removidos ou alterados a qualquer momento sem aviso
              prévio.
            </p>

            <h3>3. Compras e pagamentos</h3>
            <p>
              As compras realizadas são finais. Não oferecemos reembolso, salvo
              em casos específicos de erro técnico ou cobrança indevida.
            </p>
            ...
            <p>
              Podemos atualizar estes termos periodicamente. Ao continuar usando
              o site, você concorda com as modificações.
            </p>

            <p
              style={{ fontSize: "0.9rem", color: "#777", textAlign: "right" }}
            >
